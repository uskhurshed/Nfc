...
import com.easyapps.nfc.databinding.FragmentReadFileBinding
import java.io.File
...
class ReadFileFragment : Fragment() {
    ...
    private fun initView() {
        ...
        binding.btnSaveFile.setOnClickListener {
            val filename = if (binding.etNameOfFile.text.isBlank()) "MyCommands.txt" else binding.etNameOfFile.text.toString()
            listener?.writteTextInFile(File(Environment.getExternalStorageDirectory().absolutePath + "/EMV/", filename), binding.etCommandLine.text.toString(), false)
            Toast.makeText(activity, "Saved", Toast.LENGTH_SHORT).show()
        }

        binding.btnSend.setOnClickListener {
            val commands = getCommands(binding.etCommandLine.text.toString(), this::detailText)
        ...
        binding.btnSendToService.setOnClickListener {
            ...
            val pref = requireActivity().getSharedPreferences("EMV", Context.MODE_PRIVATE)
            pref.edit().putString(COMMANDS, binding.etCommandLine.text.toString()).apply()
        }
    }
    ...
    private fun detailText(text: String, it: String) {
        ...
        binding.etCommandLine.setText(wordtoSpan)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        ...
        if (requestCode == READ_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            if (resultData != null) {
                ...
                binding.etCommandLine.text.clear()
                binding.etCommandLine.setText(commandsText)
                binding.etNameOfFile.setText(getFileName(uri!!))
            }
        }
    }
