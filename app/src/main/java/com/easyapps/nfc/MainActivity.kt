...
class MainActivity : AppCompatActivity(), OnFragmentInteractionListener {
    ...
    override fun onResume() {
        ...
        if (canSetPreferredCardEmulationService()) {
            this.cardEmulation?.setPreferredService(this, ComponentName(this, "com.easyapps.nfc.NfcService"));
        }
    }
    ...
    fun createDir() {
        val emvDir = File(Environment.getExternalStorageDirectory().absolutePath + "/EMV/")
        emvDir.mkdirs()
    }
